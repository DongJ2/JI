...
int main()
{
   ...
   for (i=5;i>0;i--) {listA=list_make(i,listA);}

	for (i=1;i<10;i++){listB=list_make(i,listB);}
cout<<dot(listA,listB)<<endl;

/*listA=list_make(5,listA);listA=list_make(4,listA);listA=list_make(4,listA);listA=list_make(5,listA);
list_print(listA);cout<<endl;
listA=unique(listA);list_print(listA);cout<<endl;
list_print(listB);
listB=chop(listB,3);
list_print(listB);cout<<endl;
    for(i = 5; i>0; i--)
    {
