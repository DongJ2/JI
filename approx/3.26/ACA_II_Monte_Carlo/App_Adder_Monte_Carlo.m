...
mu2 = 30000;
sigma2 = 4000;
accurate_probability = [0.00585937 0.00732422];
accurate_error_distance = [256 4096];
accurate_error_item = 2;
...
app_error_prob = zeros(1,1000);
app_MSE = zeros(1,1000);
app_Mean_Error_Distance = zeros(1,1000);
